...
class CargaExcel extends MysqliDb{
	...
	$B = $hoja_1->rangeToArray('B2:B'.$maxFila,null,null,false,true);
	$D = $hoja_1->rangeToArray('D2:D'.$maxFila,null,null,false,true);
	$R = $hoja_1->rangeToArray('R2:R'.$maxFila,null,null,false,true);
	$U = $hoja_1->rangeToArray('U2:U'.$maxFila,null,null,false,true);
	$Z = $hoja_1->rangeToArray('Z2:Z'.$maxFila,null,null,false,true);
	$AH = $hoja_1->rangeToArray('AH2:AH'.$maxFila,null,null,false,true);
	...
	*/
    ...
    public static function hoja2($hoja_2){
     ...
     //Obtenemos columnas que necesitaremos
     $C = $hoja_2->rangeToArray('C2:C'.$maxFila,null,null,false,true);
     $N = $hoja_2->rangeToArray('N2:N'.$maxFila,null,null,false,true);
     $X = $hoja_2->rangeToArray('X2:X'.$maxFila,null,null,false,true);
