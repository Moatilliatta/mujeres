...
$lista = Seg_punto_rosa_capacitacion::listaSegPuntoRosaHuertos($punto_rosa['id']);

?>
<div class="mensaje">
    Seguimiento De Taller Emprendurismo  <?php //echo '"'.$punto_rosa['descripcion'].'"'; ?> 
</div> 
...
<div align='center'>
<form id='formhuerto' method="post" action='save_mujer_cap.php'>
<input type="hidden" name="tipo" value="huerto">    
