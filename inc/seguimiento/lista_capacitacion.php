...
list($lista,$p) = SegCapacitacionMujer::listaCapacitacionMujer($id_mujeres_avanzando,null,'seguimiento');
...
<?php if($lista !=null ){ ?>
<div class="mensaje"> Capacitaciones de Punto Rosa Otorgadas </div>
<?php } ?>
...
<table class="tablesorter">
    ...
    <?php }else{ ?>
    <div class="mensaje">
        No tiene Capacitaciones de Punto Rosa Asignadas
    </div>
