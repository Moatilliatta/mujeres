...
$("#id_tipo_lugar").change(function(){
    ...
    $(document).on("submit","#carga_archivo", function (e) {     
      ...
      frmAjaxPct(formData,'resultado','arreglo',ruta);
  ...
  //Función ajax para obtener los datos del modelo (usando json)
   ...
   function frmAjaxPct(parametros,div,accion,ruta,tipo,selector,act){
    ...
    selector = typeof selector !== 'undefined' ? selector : '#';
        ...
        $.ajax({
              ...
              envia.frmAjaxCallBack(parametros,'resultado','llama_webservice').done(pct);
  ...
  function pct(respuesta){
    ...
    if(percentVal == 100){
        ...
        envia.frmAjax(parametros,"listado","listado_prog_est",ruta);
