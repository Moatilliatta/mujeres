...
class SegColonia extends Db{
    ...
    **/
    public static function get_by_id($id_colonia){

        $datos = self::getInstance()->where('id', $id_colonia)
                                    ->getOne('colonia');
   ...
   /**
     ...
     * */
    public static function activaColonia($id_colonia){
        ...
        $sql = 'SELECT activo from `seg_colonia` where id = ?'; 

        //parámetros para la consulta
        $params = array($id_colonia);
        ...
        //Preparamos update
        self::getInstance()->where('id',$id_colonia);
        ...
        if(!self::getInstance()->update('colonia',$updateData)){
    ...
    private function listColonia($descripcion=null,$fecha_instalacion=null,$activo=1){
    ...
    public static function listadoColonia($descripcion=null,$fecha_instalacion=null,$activo=1){

        list($sql,$params) = self::listColonia($descripcion,$fecha_instalacion,$activo);
     ...
     * */
    public static function listaColonia($descripcion=null,$fecha_instalacion=null,$activo=1)
    {
        list($sql,$params) = self::listColonia($descripcion,$fecha_instalacion,$activo);
    ...
    public static function saveColonia($colonia,$id = null){
            ...
            {                       
             ...
             if($fecha_instalacion !=null) {
                ...
                /*if($homonimo === true && $esHomonimo != 'SI' && $id == NULL){
                    ...
                    if(! self::getInstance()->{$db_accion}('colonia', $insertData)){
