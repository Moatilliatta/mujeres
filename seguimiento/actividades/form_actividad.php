<?php session_start();     
    ...
    if(intval($id_edicion)>0){
        ...
        $actividad = $db->getOne('seg_actividad');
...
<form id='formSec' method="post" action='save_actividad.php'>
	<table>
        <tr>
			<td>
			...
			<td>
                ...
                <input type = 'text' id = 'nombre' name = 'nombre' value="<?php echo $actividad['nombre']; ?>" />
            </td>
		</tr>
        ...
        <tr>
            ...
            <td>
                <input type = 'text' id = 'descripcion' name = 'descripcion' value="<?php //echo $actividad['descripcion']; ?>" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type = 'text' id = 'fecha_creado' class="fecha date" name = 'fecha_creado' value="<?php //echo $actividad['fecha_creado']; ?>" />
            </td>
        </tr>
        -->
        ...
        <tr>
            ...
            <td>
                <select id="activo" name="activo">
                    ...
                    $selected = ($e['valor'] === $actividad['activo'])? "selected" : '' ;
