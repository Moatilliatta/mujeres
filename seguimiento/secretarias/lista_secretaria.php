...
//Incluimos modelo "seg_secretaria"
...
//Obtenemos listado de secretarias
list($lista,$pm) = SegSecretaria::listaSec($nombre,$fecha_creado);
...
<div id="principal">
    <div id="contenido">
        <div class="centro">
            ...
            <div  align="center">
            <h2 class="centro">Listado de Secretar&iacute;as</h2>
    ...
    <p>
        <?php if(array_key_exists('alta_secretaria',$central)){ ?>
        <a id = 'enviar' class="btn" href="alta_secretaria.php">Agregar</a>
        <?php } ?>
    </p> 
    <p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
             <?php if($l['activo']==1){ ?>
                <?php if(array_key_exists('edita_secretaria',$central)){ ?>
            
                <div title="Editar" class="ui-state-default ui-corner-all lista">                
                    <a class="ui-icon ui-icon-note" href="edita_secretaria.php?id_edicion=<?php echo $l['id']; ?>"></a>
                </div>
            
                <?php } ?>
             <?php }?> 

                <?php if(array_key_exists('activa_secretaria',$central)){ ?>                
                <div title="<?php echo ($l['activo'] == 1)? 'Eliminar' : 'Activar' ?>" class="ui-state-default ui-corner-all lista">
                    <a class="confirmation ui-icon ui-icon-<?php echo ($l['activo'] == 1)? 'closethick' : 'check'  ?>"
                       ...
                       href="activa_secretaria.php?id_activo=<?php echo $l['id']; ?>"></a>
                </div>
                <?php } ?>
